...
Next.js 15 + [opennextjs/cloudflare](https://github.com/opennextjs/opennextjs-cloudflare) delivery of the Rangewise web console.
...
- Per-env Cloudflare Pages projects: `rangewise-web-console-next-{dev,stage,prod}`
