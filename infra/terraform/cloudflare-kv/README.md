...
| `orgName` | string | `rangewise` | Org identifier |
| `owner` | string | `rangewise` | GitHub owner |
| `repo` | string | `rangewise` | GitHub repo |
| `namespace` | string | `rangewise` | Logical namespace |
