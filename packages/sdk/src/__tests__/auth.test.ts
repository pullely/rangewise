...
//   - RangewiseError hierarchy propagation with request-id passthrough
...
function client(fetchImpl: typeof fetch): Rangewise {
  return new Rangewise({ baseUrl: "https://api.test", fetch: fetchImpl });
}
...
describe("AuthClient", () => {
  ...
  it("client.auth is wired onto the Rangewise class", () => {
