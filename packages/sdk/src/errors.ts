// Typed error hierarchy for the Rangewise SDK.
//
...
// codes (forward compatibility) fall back to the generic `RangewiseError`
...
export interface RangewiseErrorInit {
 ...
 * `quota_exceeded`) decode to this class — `instanceof RangewiseError`
 * still matches.
 */
export class RangewiseError extends Error {
  ...
  constructor(init: RangewiseErrorInit) {
    super(init.envelope.message);
    this.name = "RangewiseError";
...
export class BadRequestError extends RangewiseError {
  constructor(init: RangewiseErrorInit) {
    super(init);
...
export class UnauthenticatedError extends RangewiseError {
  constructor(init: RangewiseErrorInit) {
    super(init);
...
export class ForbiddenError extends RangewiseError {
  constructor(init: RangewiseErrorInit) {
    super(init);
...
export class NotFoundError extends RangewiseError {
  constructor(init: RangewiseErrorInit) {
    super(init);
...
export class ConflictError extends RangewiseError {
  constructor(init: RangewiseErrorInit) {
    super(init);
...
export class ValidationError extends RangewiseError {
...
export class PreconditionFailedError extends RangewiseError {
  constructor(init: RangewiseErrorInit) {
    super(init);
...
export class UnsupportedError extends RangewiseError {
  constructor(init: RangewiseErrorInit) {
    super(init);
...
export class InternalError extends RangewiseError {
  constructor(init: RangewiseErrorInit) {
    super(init);
...
export interface RateLimitErrorInit extends RangewiseErrorInit {
...
export class RateLimitError extends RangewiseError {
...
/**
 * Decode an HTTP `Response` into the appropriate `RangewiseError` subclass.
 *
 * Forward-compatible: unknown error codes resolve to the base `RangewiseError`.
...
export async function decodeError(
  ...
  switch (envelope.code as ErrorCode) {
    ...
    default:
      ...
      return new RangewiseError(init);
  }
}

function decodeRateLimit(
  init: RangewiseErrorInit,
  response: Response,
): RateLimitError {
