// `rangewise webhook verify` — local cryptographic verification of a
// Rangewise outbound webhook delivery (Task 0106).
//
...
//     command is usable on a fresh install with no `rangewise login`.
