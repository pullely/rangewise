...
//   - `~/.config/rangewise/credentials.json` (0600)
//   - `~/.config/rangewise/config.json`     (0644)
//
// Override via `RANGEWISE_CONFIG_DIR` (used heavily by tests).
...
export function resolveConfigDir(): string {
  ...
  // the dir they expect; fall back to `~/.config/rangewise` everywhere
